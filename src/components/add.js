...
class Add extends Component {
    ...
    render () {
      ...
      <form className="form-horizontal" onSubmit={this.props.submited}>
        <div className="form-group">
          <label className="control-label col-sm-2">Site-App
          </label>
          <div className="col-sm-10 col-md-4">
            <input type="text" id="app" className="form-control" onChange={this.props.changed} />
          </div>
          <label className="control-label col-sm-2">Site-Link
          </label>
          <div className="col-sm-10 col-md-4">
            <input type="text" id="url" className="form-control" onChange={this.props.changed}/>
          </div>
          <label className="control-label col-sm-2">User
          </label>
          <div className="col-sm-10 col-md-4">
            <input type="text" id="user" className="form-control" onChange={this.props.changed}/>
          </div>
          <label className="control-label col-sm-2">Password
          </label>
          <div className="col-sm-10 col-md-4">
            <input type="text" id="pass" className="form-control" onChange={this.props.changed}/>
          </div>
          <label className="control-label col-sm-2">Email
          </label>
          <div className="col-sm-10 col-md-4">
            <input type="text" id="email" className="form-control" onChange={this.props.changed}/>
          </div>
        </div>
